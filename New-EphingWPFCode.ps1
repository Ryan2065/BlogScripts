...
<#
    ...
    .EXAMPLE
        New-EphingWPFCode -VariableName 'NewWindow'
    ...
    .PARAMETER xaml
        Specify the XAML code you want to parse

    .PARAMETER CreateClass
        You'll only want this if you do bindings in your XAML code. Will create the C# code to make a class for the XAML

    .PARAMETER HideConsoleWindow
        Hide the conosle window when running the window - NOT IMPLEMENTED YET

    .PARAMETER MultipleThreads
        Add a threading template for the buttons. - NOT IMPLEMENTED YET
